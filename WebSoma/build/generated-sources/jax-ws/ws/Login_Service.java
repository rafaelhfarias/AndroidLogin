 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://WS/", wsdlLocation = "http://localhost:8080/WSSoma/Login?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WSSoma/Login?wsdl");
